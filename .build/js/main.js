...
var _onscreen = __webpack_require__(39);
...
!function (global, factory) {
  "object" == ( false ? "undefined" : (0, _typeof3.default)(exports)) && "undefined" != typeof module ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  function attach() {
    ...
    var trackedElements = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        selectors = (0, _keys2.default)(trackedElements),
      ...
      trackedElements[selector].nodes.forEach(function (item) {
        if (testVisibility(item.node, options) ? (item.wasVisible = item.isVisible, item.isVisible = !0) : (item.wasVisible = item.isVisible, item.isVisible = !1), item.isVisible === !0 && item.wasVisible === !1) {
          if (!trackedElements[selector].enter) return;(0, _keys2.default)(trackedElements[selector].enter).forEach(function (callback) {
          ...
          if (!trackedElements[selector].leave) return;(0, _keys2.default)(trackedElements[selector].leave).forEach(function (callback) {
    ...
    var enterCallbacks = (0, _keys2.default)(this.trackedElements[selector].enter || {}),
        leaveCallbacks = (0, _keys2.default)(this.trackedElements[selector].leave || {});if ({}.hasOwnProperty.call(this.trackedElements, selector)) if (handler) {
    ...
    var _this = this,
        options = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { tolerance: 0, debounce: 100, container: window };this.options = {}, this.trackedElements = {}, (0, _defineProperties2.default)(this.options, { container: { configurable: !1, enumerable: !1, get: function get() {
        ...
        } }, debounce: { get: function get() {
          return parseInt(options.debounce, 10) || 100;
        }, set: function set(value) {
          options.debounce = value;
        } }, tolerance: { get: function get() {
      ...
      (0, _keys2.default)(_this.trackedElements).forEach(function (element) {
...
$export($export.S + $export.F * !__webpack_require__(1), 'Object', { defineProperties: __webpack_require__(29) });
